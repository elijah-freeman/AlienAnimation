class SceneManager {
    ...
    loadLevelOne() {
        ...
        this.game.addEntity(new GreenAlien(this.game, 900, PARAMS.CANVAS_HEIGHT - 2 * PARAMS.BLOCKWIDTH+30, 0));
        this.game.addEntity(new GreenAlien(this.game, -100, PARAMS.CANVAS_HEIGHT - 2 * PARAMS.BLOCKWIDTH+30, 0));
